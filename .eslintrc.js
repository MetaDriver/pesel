module.exports = {
  ...
  rules: {
    ...
    'comma-dangle': 'off',
    // висящие запятые являются фичей JS, а не багом.
    ...
    semi: 'off',
    // пропуск точек с запятой в конце операторов во многих случаях
    ...
    // замедляет парсер JS движка (требует "заглядывания вперёд" чтобы убедится
    // что оператор завершён)
